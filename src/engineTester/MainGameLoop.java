...
public class MainGameLoop{
	...
	private static int changeScreen = 1; // 1 Game, 2 Menu
	...
	public static void main(String[] args) {
		...
		while(!Display.isCloseRequested()){
			...
			if(changeScreen == 1){
				...
				//GuiTexture MenuButton = new GuiTexture(loader.loadTexture("homebutton"), new Vector2f(-0.95f, 0.90f), new Vector2f(0.06f, 0.1f));
				//guiTextures.add(MenuButton);
				//FontType fontMenu = new FontType(loader.loadTexture("candara"), new File("res/candara.fnt"));
				//GUIText textMenu = new GUIText("GAME", 9, fontMenu, new Vector2f(0.0f, 0.0f), 1f, true);
				//textMenu.setColour(1f, 1f, 1f);
				...
				GuiTexture gui = new GuiTexture(loader.loadTexture("landscape"), new Vector2f(1f, -0.5f), new Vector2f(2f, 3f));
				guis.add(gui);

				GuiRenderer guiRenderer = new GuiRenderer(loader);

				FontType fontMenu = new FontType(loader.loadTexture("candara"), new File("res/candara.fnt"));
				GUIText textMenu = new GUIText("3D game", 7, fontMenu, new Vector2f(0f, 0.05f), 1f, true);
				textMenu.setColour(0f, 0f, 0f);

				FontType fontPlay = new FontType(loader.loadTexture("candara"), new File("res/candara.fnt"));
				GUIText textPlay = new GUIText("Press R to play", 2, fontPlay, new Vector2f(0f, 0.95f), 1f, true);
				textPlay.setColour(0f, 0f, 0f);

				while (changeScreen == 2) {
